...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pip2pi-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7758&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pip2pi-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pip2pi` can be installed with:

```
conda install pip2pi
```

It is possible to list all of the versions of `pip2pi` available on your platform with:
